...
// Endpoints with fallback values if environment variables are unset
const httpEndpoint =
...
// Type definition with readonly property (SonarLint compliance)
...
export function ApolloWrapper({ children }: ApolloWrapperProps) {
  ...
  // Render loading state if client is null or auth is still loading
...
function createApolloClient(
  ...
  // Simplified auth headers (reduces complexity)
